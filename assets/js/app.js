...
<header class="header">
    <nav class="container nav">
        <a href="/" class="logo">
            <div class="logo-icon">
                <svg width="42" height="42" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
